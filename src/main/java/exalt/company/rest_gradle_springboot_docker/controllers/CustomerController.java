package exalt.company.rest_gradle_springboot_docker.controllers;


import exalt.company.rest_gradle_springboot_docker.models.Customer;
import exalt.company.rest_gradle_springboot_docker.repo.RepoDB;
...
public class CustomerController {
    ...
    private RepoDB repositoryDB ;

    @Autowired
    public CustomerController(RepoDB repositoryDB){
